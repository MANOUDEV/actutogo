                            ...
                            >
                                ...
                                <div>
                                    <div class="card border">
                                        ...
                                        <!-- Card body -->
                                        <div class="card-body">
                                            <h5 class="card-title"><a href="/events" class="stretched-link">Les évènnements</a></h5>
                                         ...
                                         <!-- Card footer -->
                                         <div class="card-footer pb-3 d-grid">
                                            <a href="/events" class="btn btn-sm btn-dark mb-0">Voir nos évènnements</a>
                                        </div>
                                ...
                                <div>
                                    <div class="card border">
                                        ...
                                        <!-- Card body -->
                                        <div class="card-body">
                                            <h5 class="card-title"><a href="/pub" class="stretched-link">Les publicités</a></h5>
                                         ...
                                         <!-- Card footer -->
                                         <div class="card-footer pb-3 d-grid">
                                            <a href="/pub" class="btn btn-sm btn-dark mb-0">Voir nos publicités</a>
                                        </div>
