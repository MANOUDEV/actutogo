...
@section('title') Page introuvable @endsection
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9 text-center mx-auto my-0 my-md-5 py-0 py-lg-5 position-relative z-index-9">
                ...
                <p>Soit quelque chose s'est mal passé, soit cette page n'existe plus.</p>
                <a href="/" class="btn btn-danger-soft mt-3"><i class="fas fa-long-arrow-alt-left me-3"></i>Revenir à la page d'accueil</a>
            </div>
        </div>
    </div>
</section>
