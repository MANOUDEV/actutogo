...
<template>
    <section class="overflow-hidden">
        ...
        <div class="col-md-9 text-center mx-auto my-0 my-md-5 py-0 py-lg-5 position-relative z-index-9">
            ...
            <!-- SVG shape START -->
            <!-- Content -->
            <h1 class="display-1 text-primary">Attention! </h1>
            <h5>Desolé il semberait que vous n'etes pas autorisé à acceder à cette page.</h5>
            <a href="/admin/dashboard" v-if="nbRsp == '&nbtsd!?'" class="btn btn-danger-soft mt-3"><i class="fas fa-long-arrow-alt-left me-3"></i>Tableau de bord.</a>
            <a href="/pub/dashboard" v-else-if="nbRsp == '&nbrsp?!'" class="btn btn-danger-soft mt-3"><i class="fas fa-long-arrow-alt-left me-3"></i>Tableau de bord.</a>
            <a href="/" v-else class="btn btn-danger-soft mt-3"><i class="fas fa-long-arrow-alt-left me-3"></i>Page d'accueil.</a>
        </div>
        </div>
        </div>
    </section>
