<template>
    <section class="py-4">
                ...
                <div class="row g-4 pb-4">
                    <div class="col-12">
                        ...
                        <div class="d-sm-flex justify-content-sm-between align-items-center">
                            ...
                            <router-link style="cursor: pointer" :to="{'name': 'pub.authors'}" class="btn btn-sm btn-primary mb-0"><i class="fas fa-eye me-2"></i>Voir les auteurs</router-link>
                        </div>
                    </div>
                </div>
                <div class="row g-4">
     ...
     <!-- Modal Form -->
     <div class="modal fade" id="authFormModalAuthorsCreate" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" @click="authFormModalAuthorsCreateClose" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
...
export default {
    ...
    methods:{
        ...
        authFormModalAuthorsCreateClose(){
            ...
            $('#authFormModalAuthorsCreate').modal('hide');
        },


        authFormModalAuthorsCreateShow(){
            ...
            $('#authFormModalAuthorsCreate').modal('show');
        },
        ...
        async submitLogin(){
            ...
            if(this.getterLoginStatus === 'success pub'){
                ...
                if(this.remember_me){
                    ...
                    this.authFormModalAuthorsCreateClose()
            ...
            if(localStorage.getItem('access_token') && localStorage.getItem('nbRsp')){
                ...
                if(this.gettersRoleStatus === 'success'){
                    ...
                    if((this.meRoleName == localStorage.getItem('nbRsp')) && (localStorage.getItem('nbRsp') === '&nbrsp?!')){
                        ...
                        this.authFormModalAuthorsCreateShow()
