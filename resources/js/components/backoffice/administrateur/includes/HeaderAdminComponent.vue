            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav navbar-nav-scroll mx-auto">
                        ...
                        <!-- Nav item 1 Demos -->
                        <li class="nav-item"><router-link style="font-size: 0.9375rem" class="nav-link" :to="{name: 'admin.dashboard'}"><i class="bi bi-house-door me-1"></i>Tableau de bord</router-link></li>
                            ...
                            <li class="px-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="btn btn-primary-soft btn-round mb-0 ">
                                       <router-link :to="{name: 'admin.profile'}"> <i class="bi bi-person" ></i></router-link>
                                    </div>
                                    &nbsp; &nbsp; &nbsp;
                                    <div v-if="dataReady">
                                        <router-link class="h6 mt-2 mt-sm-0" :to="{name: 'admin.profile'}">{{meProfileUserName}}</router-link>
