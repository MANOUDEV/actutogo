            ...
            <div class="card-body p-3 pb-0">
                <div class="col-12">
                    <div class="row g-4 mb-4">
                        <div v-if="publicationStoreArticlesCreateMessage">
                            <div class="alert alert-danger"  role="alert">
                                {{ publicationStoreArticlesCreateMessage }}
                            </div>
                        </div>

                        <form>
                            <div class="row" v-if="stepStoreArticlesFirstState">
                                <div class="col-md-12">
                                    <!-- Message -->
                                    <div class="mb-3">
                                ...
                                <div class="col-lg-6 mt-3" v-if=" publicationStoreArticlesCreateErrors.author">
                                    ...
                                    <VueMultiselect
                                        ...
                                        track-by="authorName"
                                    />
                                    <div v-for="errorauthor in  publicationStoreArticlesCreateErrors.author" :key="errorauthor" class="invalid-feedback">
                                        {{ errorauthor }}
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 mt-3" v-if=" publicationStoreArticlesCreateErrors.category">
                                    ...
                                    <VueMultiselect
                                        ...
                                        track-by="name"
                                    />
                                    <div v-for="errorcategory in  publicationStoreArticlesCreateErrors.category" :key="errorcategory" class="invalid-feedback">
                                        {{ errorcategory }}
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-end mt-2" >
                                    ...
                                    <button type="submit"  @click="stepStoreArticlesFirstToTwoButton" class="btn btn-primary">Suivant <i class="fa fa-angle-right"></i></button>
                                </div>
                            </div>
                            <div   v-if="stepStoreArticlesTwoState">
                                ...
                                <div class="col-lg-12 mt-3" v-if=" publicationStoreArticlesCreateErrors.tag">
                                    ...
                                    <VueMultiselect
                                        ...
                                        track-by="name"
                                    />
                                    <div v-for="errortag in  publicationStoreArticlesCreateErrors.tag" :key="errortag" class="invalid-feedback">
                                        {{ errortag }}
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-end mt-4"  >
                                    <button type="button" @click="stepStoreArticlesTwoToFirstButton" class="btn btn-danger border-0 me-2"><i class="fa fa-angle-left"></i>Précédent</button>
                                    <button type="submit"  @click="stepStoreArticlesTwoToThreeButton" class="btn btn-primary">Suivant<i class="fa fa-angle-right"></i></button>
                                </div>
                            </div>
                            <div   v-if="stepStoreArticlesThreeState">
                                <div class="row">
                                    <div class="col-xl-8">
                                        <!-- Chart START -->
                                        <div class="card border ">
                                            ...
                                            <!-- Card body -->
                                            <div class="card-body">
                                                <label class="form-label">Uploadez ou selectionnez vos fichiers</label>
                                                <div class="d-flex flex-wrap gap-3">
                                                    ...
                                                    <div class="flex-fill" @click="LinkState">
                                                        ...
                                                        <label class="btn btn-outline-light w-100" for="option2">
                                                            ...
                                                            <span class="d-block">Liens vidéos</span>
                                                        </label>
                                                    </div>
                                                    <!-- Post type item -->
                                                    <div class="flex-fill"  @click="IframeState">
                                                        ...
                                                        <label class="btn btn-outline-light w-100" for="option3">
                                                            ...
                                                            <span class="d-block">Iframes vidéos</span>
                                                        </label>
                                                    </div>
                                                    <!-- Post type item -->
                                                    <div class="flex-fill"  @click="ExistState">
                                                        ...
                                                        <label class="btn btn-outline-light w-100" for="option4">
                                                            ...
                                                            <span class="d-block">Déjà existant</span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-lg-12 mb-3" >
                                                        <div class="card border ">
                                                            ...
                                                            <div class="card-body p-3" v-if="emptyFiles == 0">
                                                                <div class="row g-3" >
                                                                    <div class="col-sm-6 col-lg-4" v-for="result in filesData.files.data" :key="result.id">
                                                ...
                                                <div class="row" v-else>
                                                    ...
                                                    <div v-for="info in files_selected" :key="info">
                                                        ...
                                                        <div class="card">
                                                            <div class="row g-3">
                                                                <div class="col-3">
                                                                    <img class="rounded-3" v-if="info.type_file_id == 1" :src='getImage(info.file_url)'>
                                                                    <video class="rounded-3" style="height: 50px" muted v-else-if="info.type_file_id == 2" :src='getImage(info.file_url)'  ></video >
                                                                </div>
                                                                <div class="col-9">
                                                                    <h6><span class="  text-reset fw-bold">{{info.file_name}}</span></h6>
                                                                    <!-- Card info -->
                                                                    <ul class="nav nav-divider align-items-center  small mt-2">
                                                                        <li class="nav-item">
                                                                            <span @click="removeFiles(info)" style="cursor: pointer" class="text-reset btn-link">Modifier</span>
                                                                        </li>
                                                                        <li class="nav-item">
                            ...
                            <div  v-if="stepStoreArticlesFourState">
                                <div class="row">
                                    <div class="col-xl-7">
                                        <!-- Chart START -->
                                        <div class="card border h-100">
                                            ...
                                            <!-- Card body -->
                                            <div class="card-body p-3" v-if="images_og.length != 0">
                                                <div class="row g-3" >
                                                    <div class="col-sm-6 col-lg-4" v-for="result in images_og" :key="result ">
                                                        <div class="card bg-transparent" v-if="result.type_file_id == 1">
                                                            <!-- Card img -->
                                ...
                                <div class="d-flex justify-content-end mt-4"  >
                                    <button type="button" @click="stepStoreArticlesFourToThreeButton" class="btn btn-danger border-0 me-2"><i class="fa fa-angle-left"></i>Précédent</button>
                                    <button type="submit"  @click="stepStoreArticlesFourToFiveButton" class="btn btn-primary">Suivant<i class="fa fa-angle-right"></i></button>
                                </div>
                            </div>
                            <div v-if="stepStoreArticlesFiveState">
                                <div class="row" v-if="alreadyCreate == false">
                                    ...
                                    <div class="d-flex justify-content-end mt-4" v-if="loadingPublicationStoreArticlesCreate == false">
                                        <button type="button" @click="stepStoreArticlesFourToThreeButton" class="btn btn-danger border-0 me-2"><i class="fa fa-angle-left"></i>Précédent</button>
                                        <button type="submit"  @click="publicationStoreArticles" class="btn btn-primary">Enregistrer</button>
                                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" @click="authFormModalpublicationStoreArticlesCreateClose" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
...
export default {
    ...
    components: {
        QuillEditor, Bootstrap5Pagination, TailwindPagination,VueMultiselect
    },
    ...
    data () {
        return {
            ...
            showPsw: false,
            showPswC: false,
            loadingPublicationStoreArticlesCreate: false,
            alreadyCreate: false,
            config: {
                events: {
            ...
            stepStoreArticlesFirstState: true,
            stepStoreArticlesTwoState: false,
            stepStoreArticlesThreeState: false,
            stepStoreArticlesFourState: false,
            stepStoreArticlesFiveState: false,
    ...
    computed: {
        ...
        ...mapGetters('articlesAdmin',{
            getterInfosPublicationStoreArticlesStatus:'getInfosPublicationStoreArticlesStatus',
            getterInfosPublicationStoreArticlesMessage:'getInfosPublicationStoreArticlesMessage',
            getterInfosPublicationStoreArticlesData:'getInfosPublicationStoreArticlesData',
            getterInfosPublicationStoreArticlesErrors:'getInfosPublicationStoreArticlesErrors',
    ...
    methods:{
        ...
        ...mapActions("articlesAdmin",{
          actionsPublicationStoreArticlesDataRequest:'publicationStoreArticlesDataRequest',
        ...
        addPlusButton(){
            this.cancelFirst()
            this.stepStoreArticlesTwoToFirstButton()
            this.alreadyCreate = false
        },

        stepStoreArticlesFirstToTwoButton(){
            this.stepStoreArticlesFirstState= false
            this.stepStoreArticlesTwoState= true
            this.stepStoreArticlesThreeState= false
        },

        stepStoreArticlesTwoToThreeButton(){
            this.stepStoreArticlesFirstState= false
            this.stepStoreArticlesTwoState= false
            this.stepStoreArticlesThreeState= true
        },

        stepStoreArticlesThreeToFourButton(){
            this.stepStoreArticlesFirstState= false
            this.stepStoreArticlesTwoState= false
            this.stepStoreArticlesThreeState= false
            this.stepStoreArticlesFourState= true
        },

        stepStoreArticlesFourToFiveButton(){
            this.stepStoreArticlesFirstState= false
            this.stepStoreArticlesTwoState= false
            this.stepStoreArticlesThreeState= false
            this.stepStoreArticlesFourState= false
            this.stepStoreArticlesFiveState= true
        },

        stepStoreArticlesFiveToFourButton(){
            this.stepStoreArticlesFirstState= false
            this.stepStoreArticlesTwoState= false
            this.stepStoreArticlesThreeState= false
            this.stepStoreArticlesFourState= true
            this.stepStoreArticlesFiveState= false
        },

        stepStoreArticlesFourToThreeButton(){
            this.stepStoreArticlesFirstState= false
            this.stepStoreArticlesTwoState= false
            this.stepStoreArticlesThreeState= true
            this.stepStoreArticlesFourState= false
        ...
        stepStoreArticlesThreeToTwoButton(){
            this.stepStoreArticlesFirstState= false
            this.stepStoreArticlesTwoState= true
            this.stepStoreArticlesThreeState= false
            this.stepStoreArticlesFourState= false
        ...
        stepStoreArticlesTwoToFirstButton(){
            this.stepStoreArticlesFirstState= true
            this.stepStoreArticlesTwoState= false
            this.stepStoreArticlesThreeState= false
            this.stepStoreArticlesFourState= false
            this.stepStoreArticlesFiveState= false
        ...
        authFormModalpublicationStoreArticlesCreateClose(){
            ...
            this.errorsLogin = []
            $('#authFormModalpublicationStoreArticlesCreate').modal('hide');
        },
        ...
        authModalClick(action_auth="LIST", name=null, slug=null){
            ...
            if(this.authSectionModal == "CREATEARTICLE"){

                this.loadingPublicationStoreArticlesCreate = false

            }
            $('#authFormModalpublicationStoreArticlesCreate').modal('show');
            ...
            if(this.getterLoginStatus === 'success admin'){
                ...
                if(this.remember_me){
                    ...
                    if(this.authSectionModal== 'CREATEARTICLE'){
                        ...
                        this.authFormModalpublicationStoreArticlesCreateClose()

                        this.loadingPublicationStoreArticlesCreate = true

                        this.publicationStoreArticlesCreate()
        ...
        async publicationStoreArticles(){
        ...
        async publicationStoreArticlesCreate(){

            this.loadingPublicationStoreArticlesCreate = true

            this.authSectionModal= 'CREATEARTICLE'

            this.publicationStoreArticlesCreateMessage =  null
            this.publicationStoreArticlesCreateErrors = []
            ...
            if( this.getterInfosPublicationStoreArticlesStatus ==="success"){
                ...
                this.publicationStoreArticlesCreateData = this.getterInfosPublicationStoreArticlesData
                ...
                Toast.fire({
                    icon: 'success',
                    title: this.getterInfosPublicationStoreArticlesMessage
                })
            ...
            }else if( this.getterInfosPublicationStoreArticlesStatus ==="empty"){

                this.publicationStoreArticlesCreateMessage = this.getterInfosPublicationStoreArticlesMessage

                this.publicationStoreArticlesCreateErrors = this.getterInfosPublicationStoreArticlesErrors

                this.loadingPublicationStoreArticlesCreate = false


            }else if( this.getterInfosPublicationStoreArticlesStatus ==="error"){
