<template>
                ...
                <div class="row g-4 pb-4">
                    <div class="col-12">
                        ...
                        <div class="d-sm-flex justify-content-sm-between align-items-center">
                            <h1 class="mb-2 mb-sm-0 h2">Mes abonnés <span class="badge bg-primary bg-opacity-10 text-primary"> {{ newsLetterListData.newsLettersCount  }} </span></h1>
                            <span style="cursor: pointer" @click="authModalClick('CREATE')" class="btn btn-sm btn-primary mb-0"><i class="fas fa-plus me-2"></i>Ajouter un abonné</span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card border">
                            ...
                            <div class="card-header border-bottom p-3">
                                ...
                                <div class="row g-3 align-items-center justify-content-between">
                                    <!-- Search bar -->
                                    <div class="col-md-9">
                                        <form class="rounded position-relative" method="GET" @submit.prevent="show">
                                            <input class="form-control bg-transparent" v-model="search" @input="show" name="search" type="search" placeholder="Rechercher un abonné ..." aria-label="Search">
                                    ...
                                    <div class="col-md-3">
                                        <form class="rounded position-relative" method="GET" >
                                            <select class="form-select" @change="handleSelectionSearchByStatus($event)" v-model="status" name="status" id="status">
                                                <option value="3" >Tous les emails</option>
                                                <option value="1" >Les emails acceptés</option>
                                                <option value="2" >Les emails bloqués</option>
                                                <option value="0" >Les emails en attente de validation</option>
                                            </select>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive border-0">
                                    <table class="table align-middle p-4 mb-0 table-hover">
                                        ...
                                        <thead class="table-dark">
                                            <tr>
                                                <th scope="col" class="border-0 rounded-start">Email</th>
                                                <th scope="col" class="border-0">Publications reçues</th>
                                        ...
                                        <tbody class="border-top-0">
                                            <!-- Table row -->
                                            <tr v-for="result in newsLetterListData.newsLetters.data" :key="result.id">
                                                ...
                                                <td>
                                                    <span style="cursor: pointer" @click="authModalClick('ACTIVATE',result.email, result.slug )" v-if="result.status === 0" class="badge bg-primary bg-opacity-10 text-primary mb-2">En attente</span>
                                                    <span style="cursor: pointer" @click="authModalClick('BLOCK',result.email, result.slug )" v-else-if="result.status == 1" class="badge bg-success bg-opacity-10 text-white-force mb-2">Accepté</span>
                                                    <span style="cursor: pointer" @click="authModalClick('ACTIVATE',result.email, result.slug )" v-else class="badge bg-danger bg-opacity-10 text-danger mb-2"> Bloqué </span>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <span style="cursor: pointer" @click="authModalClick('UPDATE',result.email, result.slug )" class="btn btn-primary btn-round mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Message" aria-label="Message">
                                                        <i class="bi bi-pencil-fill"></i>
                                                        </span>
                                                        <span style="cursor: pointer" @click="authModalClick('DELETE',result.email, result.slug )" class="btn btn-danger btn-round mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Block" aria-label="Block">
                            ...
                            <div class="card-body p-3 pb-0" v-else-if="empty == 1">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <h5 style="text-align: center; margin-top: -50px"> {{ newsLetterListMessage  }} </h5>
                                    </div>
                                    <div class="col-md-3"></div>
                                </div>
                            </div>
                            ...
                            <div class="card-footer p-3" v-if="empty == 0">
                                ...
                                <div class="d-sm-flex justify-content-sm-between align-items-sm-center">
                                    ...
                                    <Bootstrap5Pagination
                                        class="mb-0"
                                        :data="newsLetterListData.newsLetters"
                                        :limit="limit"
    ...
    <!-- Modal Form -->
    <div class="modal fade" id="authFormModalNewsLetterList" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" v-if="authSectionModal == 'CREATE'">
                <div class="modal-header">
                    <h5 class="modal-title">Ajouter un abonné</h5>
                    <button type="button" class="btn-close" @click="authFormModalNewsLetterListClose" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form>
                    <div class="modal-body">
                        <div v-if="newsLetterStoreMessage">
                            <div class="alert alert-danger"  role="alert">
                                {{ newsLetterStoreMessage }}
                            </div>
                        </div>

                        <!-- Email -->
                        <div class="mb-3" v-if="newsLetterStoreErrors.email">
                            <label class="form-label" for="exampleInputEmailnewsLetterCreate">Email de l' abonné</label>
                            <input type="text" v-model="email" name="email" class="form-control is-invalid" id="exampleInputEmailnewsLetterCreate" placeholder="Entrez l' email de l'abonné">
                            <div v-for="errorname in newsLetterStoreErrors.email" :key="errorname" class="invalid-feedback">
                                {{ errorname }}
                            </div>
                        </div>
                        <div class="mb-3" v-else>
                            <label class="form-label" for="exampleInputEmailLoginInvalid">Email de l' abonné</label>
                            <input type="text" v-model="email" name="email" class="form-control" id="exampleInputEmailnewsLetterCreate" placeholder="Entrez l' email de l'abonné">
                        </div>
                    </div>
                    <div class="modal-footer" >
                        <div  v-if="!loadingCreate" style="margin-top: -5px; margin-bottom: -10px">
                            ...
                            &nbsp;
                            <span><span class="btn btn-danger" @click="authFormModalNewsLetterListClose">Fermez</span></span>
                        </div>
            ...
            <div class="modal-content" v-if="authSectionModal == 'UPDATE'">
                <div class="modal-header">
                    <h5 class="modal-title">Modifier un abonné</h5>
                    <button type="button" class="btn-close" @click="authFormModalNewsLetterListClose" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form>
                    <div class="modal-body">
                        <div v-if="newsLetterUpdateMessage">
                            <div class="alert alert-danger"  role="alert">
                        ...
                        <!-- Email -->
                        <div class="mb-3" v-if="newsLetterUpdateErrors.email">
                            <label class="form-label" for="exampleInputEmailnewsLetterCreate">Email de l' abonné</label>
                            <input type="text" v-model="email" name="email" class="form-control is-invalid" id="exampleInputEmailnewsLetterCreate" placeholder="Entrez l' email de l'abonné">
                            <div v-for="errorname in newsLetterUpdateErrors.email" :key="errorname" class="invalid-feedback">
                                {{ errorname }}
                            </div>
                        </div>
                        <div class="mb-3" v-else>
            ...
            <div class="modal-content" v-if="authSectionModal == 'DELETE'">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex justify-content-center">
                        <p class="text-center">Toutes données relatives à cet abonné seront aussi supprimées.</p>
                    </div>
                    <div class="d-flex justify-content-center" v-if="!loadingDelete" style="margin-top: -5px; margin-bottom: -10px">
                        ...
                        &nbsp;
                        <span><span class="btn btn-success" @click="authFormModalNewsLetterListClose">Annuler</span></span>
                    </div>
            ...
            <div class="modal-content" v-if="authSectionModal == 'ACTIVATE'">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex justify-content-center">
                        <p class="text-center">Voulez vous vraiment activer cet abonné, désormais il recevra par mail toutes vos publications.</p>
                    </div>
                    <div class="d-flex justify-content-center" v-if="!loadingActivate" style="margin-top: -5px; margin-bottom: -10px">
                        <span style="cursor: pointer" @click.prevent="activate" class="btn btn-primary">Activer</span>
                        &nbsp;
                        <span><span class="btn btn-success" @click="authFormModalNewsLetterListClose">Annuler</span></span>
                    </div>
                    <div class="d-flex justify-content-center" style="margin-top: -5px; margin-bottom: -10px" v-else>
                        <button type="button" disabled class="btn btn-primary   mx-auto w-100">
                            <i  style="color: #fff" class="fa fa-spinner fa-spin fa-1x fa-fw"></i>
                            <span class="sr-only">Loading...</span> Activation en cours ...
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-content" v-if="authSectionModal == 'BLOCK'">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex justify-content-center">
                        <p class="text-center">Voulez vous vraiment bloquer cet abonné, désormais il ne recevra plus par mail  vos publications.</p>
                    </div>
                    <div class="d-flex justify-content-center" v-if="!loadingBlock" style="margin-top: -5px; margin-bottom: -10px">
                        <span style="cursor: pointer" @click.prevent="block" class="btn btn-danger">Bloquer</span>
                        &nbsp;
                        <span><span class="btn btn-success" @click="authFormModalNewsLetterListClose">Annuler</span></span>
                    </div>
                    <div class="d-flex justify-content-center" style="margin-top: -5px; margin-bottom: -10px" v-else>
                        <button type="button" disabled class="btn btn-primary   mx-auto w-100">
                            <i  style="color: #fff" class="fa fa-spinner fa-spin fa-1x fa-fw"></i>
                            <span class="sr-only">Loading...</span> Bloquage en cours ...
                        </button>
                    </div>
                </div>
                ...
                <!-- Login Form -->
                <div class="modal-content" v-else-if="authSectionModal == 'BLOCK_AUTH' || authSectionModal == 'ACTIVATE_AUTH' || authSectionModal == 'DELETE_AUTH' || authSectionModal == 'UPDATE_AUTH' || authSectionModal == 'CREATE_AUTH' || authSectionModal == 'LIST'">
                    <div class="modal-header">
...
export default {
    ...
    data () {
        return {
            ...
            meRoleName: null,
            newsLetterListData: {},
            newsLetterListMessage: null,
            newsLetterStoreData: {},
            newsLetterStoreMessage: null,
            newsLetterStoreErrors: [],
            newsLetterUpdateData: {},
            newsLetterUpdateMessage: null,
            newsLetterUpdateErrors: [],
            newsLetterDeleteData: {},
            newsLetterDeleteMessage: null,
            style: 'bootstrap5',
            limit: 1,
            keepLength: false,
            showDisabled: false,
    ...
    computed: {
        ...
        ...mapGetters('newsLetterAdmin',{
            getterInfosNewsLetterListStatus:'getInfosNewsLetterListStatus',
            getterInfosNewsLetterListMessage:'getInfosNewsLetterListMessage',
            getterInfosNewsLetterListData:'getInfosNewsLetterListData',
            getterInfosNewsLetterSearchStatus:'getInfosNewsLetterSearchStatus',
            getterInfosNewsLetterSearchMessage:'getInfosNewsLetterSearchMessage',
            getterInfosNewsLetterSearchData:'getInfosNewsLetterSearchData',
            getterInfosNewsLetterStoreStatus:'getInfosNewsLetterStoreStatus',
            getterInfosNewsLetterStoreMessage:'getInfosNewsLetterStoreMessage',
            getterInfosNewsLetterStoreErrors:'getInfosNewsLetterStoreErrors',
            getterInfosNewsLetterStoreData:'getInfosNewsLetterStoreData',
            getterInfosNewsLetterUpdateStatus:'getInfosNewsLetterUpdateStatus',
            getterInfosNewsLetterUpdateMessage:'getInfosNewsLetterUpdateMessage',
            getterInfosNewsLetterUpdateErrors:'getInfosNewsLetterUpdateErrors',
            getterInfosNewsLetterUpdateData:'getInfosNewsLetterUpdateData',
            getterInfosNewsLetterDeleteStatus:'getInfosNewsLetterDeleteStatus',
            getterInfosNewsLetterDeleteMessage:'getInfosNewsLetterDeleteMessage',
            getterInfosNewsLetterDeleteData:'getInfosNewsLetterDeleteData',
            getterInfosNewsLetterActivateStatus:'getInfosNewsLetterActivateStatus',
            getterInfosNewsLetterActivateMessage:'getInfosNewsLetterActivateMessage',
            getterInfosNewsLetterActivateData:'getInfosNewsLetterActivateData',
            getterInfosNewsLetterBlockStatus:'getInfosNewsLetterBlockStatus',
            getterInfosNewsLetterBlockMessage:'getInfosNewsLetterBlockMessage',
            getterInfosNewsLetterBlockData:'getInfosNewsLetterBlockData',
        }),
        ...mapGetters('login',{
    ...
    methods:{
        ...
        ...mapActions("newsLetterAdmin",{
          actionsNewsLetterListDataRequest:'newsLetterListDataRequest',
          actionsNewsLetterSearchDataRequest:'newsLetterSearchDataRequest',
          actionsNewsLetterStoreDataRequest:'newsLetterStoreDataRequest',
          actionsNewsLetterUpdateDataRequest:'newsLetterUpdateDataRequest',
          actionsNewsLetterDeleteDataRequest:'newsLetterDeleteDataRequest',
          actionsNewsLetterActivateDataRequest:'newsLetterActivateDataRequest',
          actionsNewsLetterBlockDataRequest:'newsLetterBlockDataRequest',
        }),
        ...
        authFormModalNewsLetterListClose(){
            ...
            this.errorsLogin = []
            this.newsLetterUpdateMessage =  null
            this.newsLetterUpdateErrors = []
            this.newsLetterStoreMessage =  null
            this.newsLetterStoreErrors = []
            $('#authFormModalNewsLetterList').modal('hide');
        },
        ...
        authModalClick(action_auth="LIST", name=null, slug=null){
            ...
            }else if(this.authSectionModal == "ACTIVATE"){

                this.loadingActivate = false

            }else if(this.authSectionModal == "BLOCK"){

                this.loadingBlock = false

            }

            $('#authFormModalNewsLetterList').modal('show');
        },
            ...
            if(this.getterLoginStatus === 'success admin'){
                ...
                if(this.remember_me){
                    ...
                    if(this.authSectionModal== 'LIST'){
                        ...
                        this.newsLetterDelete()

                    }else if(this.authSectionModal == "ACTIVATE_AUTH"){

                        this.authSectionModal = "ACTIVATE"

                        this.newsLetterActivate()

                    }else if(this.authSectionModal == "BLOCK_AUTH"){

                        this.authSectionModal = "BLOCK"
        ...
        async getResults(page = 1){
            ...
            await this.actionsNewsLetterListDataRequest({ page : page, search: this.search});

            if( this.getterInfosNewsLetterListStatus ==="success"){

                this.newsLetterListData = this.getterInfosNewsLetterListData
            ...
            }else if( this.getterInfosNewsLetterListStatus ==="empty"){

                this.newsLetterListMessage = this.getterInfosNewsLetterListMessage
            ...
            }else if(this.getterInfosNewsLetterListStatus === 'failed'){
        ...
        async handleSelectionSearchByStatus(event, page=1){

            this.status = event.target.value

           this.authSectionModal= 'LIST'

            await this.actionsNewsLetterSearchDataRequest({ page : page, status: this.status});

            if( this.getterInfosNewsLetterSearchStatus ==="success"){

                this.newsLetterListData = this.getterInfosNewsLetterSearchData
            ...
            }else if( this.getterInfosNewsLetterSearchStatus ==="empty"){

                this.newsLetterListMessage = this.getterInfosNewsLetterSearchMessage
            ...
            }else if(this.getterInfosNewsLetterSearchStatus === 'failed'){
        ...
        async newsLetterCreate(){
            ...
            await this.actionsNewsLetterStoreDataRequest({ email : this.email});

            if( this.getterInfosNewsLetterStoreStatus ==="success"){

                this.newsLetterStoreData = this.getterInfosNewsLetterStoreData
                ...
                Toast.fire({
                    icon: 'success',
                    title: this.getterInfosNewsLetterStoreMessage
                })
            ...
            }else if( this.getterInfosNewsLetterStoreStatus ==="empty"){

                this.newsLetterStoreMessage = this.getterInfosNewsLetterStoreMessage

                this.newsLetterStoreErrors = this.getterInfosNewsLetterStoreErrors

                this.loadingCreate = false


            }else if( this.getterInfosNewsLetterStoreStatus ==="error"){
        ...
        async newsLetterUpdate(){
            ...
            await this.actionsNewsLetterUpdateDataRequest({ email : this.email, slug : this.slug,});

            if( this.getterInfosNewsLetterUpdateStatus ==="success"){

                this.newsLetterUpdateData = this.getterInfosNewsLetterUpdateData
                ...
                Toast.fire({
                    icon: 'success',
                    title: this.getterInfosNewsLetterUpdateMessage
                })
            ...
            }else if( this.getterInfosNewsLetterUpdateStatus ==="empty"){

                this.newsLetterUpdateMessage = this.getterInfosNewsLetterUpdateMessage

                this.newsLetterUpdateErrors = this.getterInfosNewsLetterUpdateErrors

                this.loadingUpdate = false


            }else if( this.getterInfosNewsLetterUpdateStatus ==="error"){
        ...
        async newsLetterDelete(){

            this.loadingDelete = true

            this.authSectionModal= 'DELETE'

            await this.actionsNewsLetterDeleteDataRequest({slug : this.slug});

            if( this.getterInfosNewsLetterDeleteStatus ==="success"){

                this.newsLetterDeleteData = this.getterInfosNewsLetterDeleteData
                ...
                Toast.fire({
                    icon: 'success',
                    title: this.getterInfosNewsLetterDeleteMessage
                })
            ...
            }else if( this.getterInfosNewsLetterDeleteStatus ==="empty"){

                this.newsLetterDeleteMessage = this.getterInfosNewsLetterDeleteMessage

                this.newsLetterDeleteErrors = this.getterInfosNewsLetterDeleteErrors

                this.loadingDelete = false


            }else if( this.getterInfosNewsLetterDeleteStatus ==="error"){
         ...
         async activate(){
            ...
            if(localStorage.getItem('access_token') && localStorage.getItem('nbRsp')){
                ...
                if(this.gettersRoleStatus === 'success'){
                    ...
                    this.authSectionModal= 'ACTIVATE_AUTH'
                }
        ...
        async newsLetterActivate(){

            this.loadingActivate = true

            this.authSectionModal= 'ACTIVATE'

            await this.actionsNewsLetterActivateDataRequest({slug : this.slug});

            if( this.getterInfosNewsLetterActivateStatus ==="success"){

                this.newsLetterActivateData = this.getterInfosNewsLetterActivateData
                ...
                Toast.fire({
                    icon: 'success',
                    title: this.getterInfosNewsLetterActivateMessage
                })
            ...
            }else if( this.getterInfosNewsLetterActivateStatus ==="empty"){

                this.newsLetterActivateMessage = this.getterInfosNewsLetterActivateMessage

                this.newsLetterActivateErrors = this.getterInfosNewsLetterActivateErrors

                this.loadingActivate = false


            }else if( this.getterInfosNewsLetterActivateStatus ==="error"){
        ...
        async block(){
            ...
            if(localStorage.getItem('access_token') && localStorage.getItem('nbRsp')){
                ...
                if(this.gettersRoleStatus === 'success'){
                    ...
                    this.authSectionModal= 'BLOCK_AUTH'
                }
        ...
        async newsLetterBlock(){

            this.loadingBlock = true

            this.authSectionModal= 'BLOCK'

            await this.actionsNewsLetterBlockDataRequest({slug : this.slug});

            if( this.getterInfosNewsLetterBlockStatus ==="success"){

                this.newsLetterBlockData = this.getterInfosNewsLetterBlockData
                ...
                Toast.fire({
                    icon: 'success',
                    title: this.getterInfosNewsLetterBlockMessage
                })
            ...
            }else if( this.getterInfosNewsLetterBlockStatus ==="empty"){

                this.newsLetterBlockMessage = this.getterInfosNewsLetterBlockMessage

                this.newsLetterBlockErrors = this.getterInfosNewsLetterBlockErrors

                this.loadingBlock = false


            }else if( this.getterInfosNewsLetterBlockStatus ==="error"){
