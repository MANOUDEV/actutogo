            ...
            <div class="col-12">
                <ul class="list-inline mt-3">
                    <li class="list-inline-item">
                        <span style="cursor: pointer" v-if="sportsState" @click="sports" class="btn btn-sm btn-success">Sports</span>
                        <span style="cursor: pointer" v-else @click="sports" class="btn btn-sm btn-primary-soft">Sports</span>
                    </li>
                    <li class="list-inline-item">
                        <span style="cursor: pointer" v-if="canState" @click="can" class="btn btn-sm btn-success">CAN</span>
                        <span style="cursor: pointer" v-else @click="can" class="btn btn-sm btn-primary-soft">CAN</span>
                    </li>
                    <li class="list-inline-item">
                        <span style="cursor: pointer" v-if="togoState" @click="togo" class="btn btn-sm btn-success">Togo</span>
                        <span style="cursor: pointer" v-else @click="togo" class="btn btn-sm btn-primary-soft">Togo</span>
                    </li>
                </ul>
            </div>
        </div>
