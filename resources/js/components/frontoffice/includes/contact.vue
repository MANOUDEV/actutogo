                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-3" v-if="errors.content">
                                        <textarea v-model="content" placeholder='Redigez le contenu de votre requête!' style=" min-height: 100px;" class="form-control is-invalid" contentType="html" ></textarea>
                                        <div id="exampleInputPassword1" v-for="errorContent in errors.content" :key="errorContent" class="invalid-feedback">
                                            {{ errorContent }}
                                        </div>
                                    </div>
                                    <div class="mb-3" v-else>
                                        <textarea v-model="content" placeholder='Redigez le contenu de votre requête!' style=" min-height: 100px;" class="form-control" contentType="html" ></textarea>
                        ...
                        <form class="contact-form" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-3" v-else>
                                        <textarea v-model="content" placeholder='Redigez le contenu de votre requête!' class="form-control" style=" min-height: 100px;" contentType="html" ></textarea>
