...
const showCommentFormState = ref(false);
...
const showCommentForm = ( )=> {
    if(showCommentFormState.value){
        showCommentFormState.value = false
    }else{
        showCommentFormState.value = true
    }
    ...
    <div v-if="loading == 0" class="mt-2">
        ...
        <div class="container" >
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <!-- Select -->
                <div class="col-xl-3">
                    <button @click="showCommentForm" class="btn btn-primary btn-sm">
