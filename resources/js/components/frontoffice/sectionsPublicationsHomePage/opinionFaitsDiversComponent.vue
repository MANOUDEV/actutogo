            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 mb-2">
                <div class="col-md-12 ">
                    <div class="d-flex mb-2">
                        ...
                        <div>&nbsp; &nbsp; &nbsp;</div>
                        <div>
                            <h2 class="text-success m-0 alaune_title">CULTURE</h2>
                            <p>Suivez nos actualités sur la culture.</p>
                        </div>
                    </div>
                    <!-- Title -->
                </div>
                ...
                <Splide :options="optionsOneOpinionFaitsDivers" aria-label="My Favorite Images">
                    ...
                    <SplideSlide v-for=" result in opinionFaitsDiversData.culture" :key="result.id">
                        <div>
                            <div class="card card-overlay-bottom card-img-scale">
                                <!-- Card Image -->
                                <img class="card-img opinion_faits_divers_first_section_img_responsive" :src='getImage(result.image_cover_url)' alt="" >
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 mb-2">
                <div class="col-md-12 ">
                    <div class="d-flex mb-2">
                        ...
                        <div>&nbsp; &nbsp; &nbsp;</div>
                        <div>
                            <h2 class="text-success m-0 alaune_title">NECROLOGIE</h2>
                            <p>Suivez nos actualités sur la nécrologie.</p>
                        </div>
                    </div>
                    <!-- Title -->
                </div>
                ...
                <Splide :options="optionsOneOpinionFaitsDivers" aria-label="My Favorite Images">
                    ...
                    <SplideSlide v-for=" result in opinionFaitsDiversData.necrologie" :key="result.id">
                        <div>
                            <div class="card card-overlay-bottom card-img-scale">
                                <!-- Card Image -->
                                <img class="card-img opinion_faits_divers_first_section_img_responsive" :src='getImage(result.image_cover_url)' alt="">
